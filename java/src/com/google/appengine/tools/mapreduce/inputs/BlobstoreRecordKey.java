...
// --------------------------- CONSTRUCTORS ---------------------------
  ...
  public BlobstoreRecordKey(BlobKey blobKey, long offset) {
...
// ------------------------ OVERRIDING METHODS ------------------------
  ...
  public boolean equals(Object obj) {
    ...
    BlobstoreRecordKey that = (BlobstoreRecordKey) obj;
  ...
  public String toString() {
    return String.format("BlobstoreRecordKey{blobKey=%s, offset=%d}", blobKey, offset);
  }
